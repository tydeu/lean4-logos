...
{P : Sort u} {T : Sort v} {L : Logic P} [N : SNat P T]
...
[N : SNat P T] [Q : SEq P T] [QTr : EqNatTrans L N Q] [NQ : NatEqNat L N Q]
...
{P : Sort u} {T : Sort v} {L : Logic P} 
[N : SNat P T] [Q : SEq P T] [QTr : EqNatLeftEuc L N Q] [NQ : NatEqNat L N Q]
