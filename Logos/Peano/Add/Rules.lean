...
class AddNatSuccEqSucc (L : Logic P) 
  (N : PNat P T) (Q : SEq P T) (A : SAdd T) (S : Succ T) := 
...
class AddNatOneEqSucc (L : Logic P) 
  (N : PNat P T) (Q : SEq P T) (A : SAdd T) (O : One T) (S : Succ T) :=
...
instance iCommOverTOfAddNatComm 
  {L : Logic P} [N : PNat P T] [Q : SEq P T] [A : SAdd T] 
...
abbrev addNatAssoc {L : Logic P} [N : PNat P T] [Q : SEq P T] [A : SAdd T]
...
abbrev eqNatAddNatLeft' {L : Logic P} 
  [N : PNat P T] [Q : SEq P T] [A : SAdd T] [K : EqNatAddNatLeft L N Q A] 
...
abbrev eqNatAddNatRight' {L : Logic P} 
  [N : PNat P T] [Q : SEq P T] [A : SAdd T] [K : EqNatAddNatRight L N Q A] 
  {c a b} (Nc Na Nb) := K.toFun a b c Na Nb Nc
...
class NatAddZero (L : Logic P) (N : PNat P T) (A : SAdd T) (Z : Zero T) :=
  toFun : L |- nat (0 + 0 : T)

abbrev natAddZero {L : Logic P} [N : PNat P T] [A : SAdd T] [Z : Zero T]
  [K : NatAddZero L N A Z] := K.toFun

-- nat (a + 0)

class NatAddNatZero (L : Logic P) (N : PNat P T) (A : SAdd T) (Z : Zero T) :=
  toFun : (a : T) -> (L |- nat a) -> (L |- nat (a + 0))

abbrev natAddNatZero {L : Logic P} [N : PNat P T] [A : SAdd T] [Z : Zero T]
  [K : NatAddNatZero L N A Z] {a} := K.toFun a

-- nat (0 + a)

class NatAddZeroNat (L : Logic P) (N : PNat P T) (A : SAdd T) (Z : Zero T) :=
  toFun : (a : T) -> (L |- nat a) -> (L |- nat (0 + a))

abbrev natAddZeroNat {L : Logic P} [N : PNat P T] [A : SAdd T] [Z : Zero T]
  [K : NatAddZeroNat L N A Z] {a} := K.toFun a 

-- nat (a + b)

class NatAddNat (L : Logic P) (N : PNat P T) (A : SAdd T) :=
  toFun : (a b : T) -> (L |- nat a) -> (L |- nat b) -> (L |- nat (a + b))

abbrev natAddNat {L : Logic P} [N : PNat P T] [A : SAdd T] 
  [K : NatAddNat L N A] {a b} := K.toFun a b

abbrev natAdd {L : Logic P} [N : PNat P T] [A : SAdd T] 
  [K : NatAddNat L N A] {a b} := K.toFun a b
