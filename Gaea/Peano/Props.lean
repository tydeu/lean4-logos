...
def eqNatRefl {P : Sort u} (T : Sort v) 
  [Nat P T] [LEq P T] [LIf P] [LForall P T] : P :=
  forall (x : T) => nat x -> x = x

-- Axiom 3
def eqNatSymm {P : Sort u} (T : Sort v) 
  [Nat P T] [LEq P T] [LIf P] [LAnd P] [LForall P T] : P :=
...
def natSuccNat {P : Sort u} (T : Sort v) 
  [Nat P T] [Succ T] [LIf P] [LForall P T] : P :=
  forall (n : T) => nat n -> nat (S n)

-- Axiom 7
def eqNatIffEqSucc {P : Sort u} (T : Sort v) 
  [LEq P T] [Succ T] [Nat P T] [LIf P] [LIff P] [LAnd P] [LForall P T] : P :=
  forall (m n : T) => nat m /\ nat n -> (m = n <-> S m = S n)

-- Axiom 7a
def eqNatToEqSucc {P : Sort u} (T : Sort v) 
  [LEq P T] [Succ T] [Nat P T] [LIf P] [LAnd P] [LForall P T] : P :=
  forall (m n : T) => nat m /\ nat n -> (m = n -> S m = S n)

-- Axiom 7b
def eqSuccToEqNat {P : Sort u} (T : Sort v) 
  [Nat P T] [LEq P T] [Succ T] [LIf P] [LAnd P] [LForall P T] : P :=
  forall (m n : T) => nat m /\ nat n -> (S m = S n -> m = n)

-- Axiom 8
def succNatEqZeroFalse {P : Sort u} (T : Type v) 
  [Nat P T] [LEq P T] [False P] [Zero T] [Succ T] [LIf P] [LAnd P] [LForall P T] : P :=
...
def addNatZeroEqNat {P : Sort u} (T : Type v) 
  [Nat P T] [LEq P T] [Add T] [Zero T] [LIf P] [LForall P T] : P :=
  forall (a : T) => nat a -> a + 0 = a

-- Axiom 2
def addNatSuccEqSucc {P : Sort u} (T : Type v) 
  [Nat P T] [LEq P T] [Add T] [Succ T] [LIf P] [LAnd P] [LForall P T] : P := 
...
def mulNatZeroEqZero {P : Sort u} (T : Type v) 
  [Nat P T] [LEq P T] [Mul T] [Zero T] [LIf P] [LForall P T] : P :=
  forall (a : T) => nat a -> a * 0 = 0

-- Axiom 2
def mulNatSuccEqAddMul {P : Sort u} (T : Type v) 
  [Nat P T] [LEq P T] [Add T] [Mul T] [Succ T] [LIf P] [LAnd P] [LForall P T] : P := 
